    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            messages: [
                ...
                { 
                    role: "user", 
                    content: "these are all the previous things i have asked you - READ THE CONTENT in the chat_messages array, do not place a super crazy heavy emphasis on the previous chat_messages, simply use them as context and ensure correct and accurate referencing, usually the most recently asked question will be at the startof the following array, respond to this question and use the rest of the array as conversation context" + req.session.chatMessages.join(' ') + "with this context, don't respond with anything like, 'it sounds like you're doing ____context____', or 'it sounds like you're discussing', or 'ahh, i see you're diving into _context_' - just respond like you're replying to the most recent message in the previous messages provided previously in this prompt in the chatmessages. continue the conversation"
                },
                {
                    role: "system",
